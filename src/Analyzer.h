...
if(debug>1) printf("-> SetBranchAddress B - photon vectors\n");
   ...
   fChain->SetBranchAddress("jetPuIdMva",&jetPuIdMva,&b_jetPuIdMva);
   fChain->SetBranchAddress("jetPuIdFlags",&jetPuIdFlags,&b_jetPuIdFlags);
   fChain->SetBranchAddress("jetPuIdFlagsMva",&jetPuIdFlagsMva,&b_jetPuIdFlagsMva);
